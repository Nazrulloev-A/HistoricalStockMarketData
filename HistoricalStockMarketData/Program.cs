...
namespace HistoricalStockMarketData;
...
class Program
{
    static void Main(string[] args)
    {
        ...
        while (continueStr == 'y')
        {
            Console.WriteLine("Enter a stock ticker that you want historic data fro: ");
            string symbol = Console.ReadLine().ToUpper();
            Console.WriteLine("Enter the amout of month of historic data that you want to retrive");
